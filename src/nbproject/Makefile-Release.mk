...
${OBJECTDIR}/CCU.o: CCU.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CCU.o CCU.cpp

${OBJECTDIR}/CCU_Node.o: CCU_Node.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CCU_Node.o CCU_Node.cpp

${OBJECTDIR}/CCU_PJS.o: CCU_PJS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CCU_PJS.o CCU_PJS.cpp
...
${OBJECTDIR}/JobGenerator.o: JobGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JobGenerator.o JobGenerator.cpp
...
${OBJECTDIR}/Node_PJS.o: Node_PJS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Node_PJS.o Node_PJS.cpp

${OBJECTDIR}/PJS.o: PJS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PJS.o PJS.cpp
